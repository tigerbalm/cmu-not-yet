...
public class LogoutRequestChannel extends ClientChannelRegistry {
    private final static String TOPIC = "/logout";
    private final static String KEY_SESSION_KEY = "session_key";

    public LogoutRequestChannel(INetworkConnection networkConnection) {
    ...
    public static MqttNetworkMessage createRequestMessage(String sessionKey) {
        JsonObject requestObject = new JsonObject().add(KEY_SESSION_KEY, sessionKey);
